...
x=5;
y=4;
Eigenface = uint8 (zeros(28, 23)); %28x23=644 pixels for each image. Eigenface null matrix 
for i = 1:20 %iteration through each image 
    for k = 0:643 % ~ each pixel 
        %converting rows to Eigenvectors for each image 
